import { ChevronRight, Clock, Facebook, Instagram, Mail, MapPin, Phone, Twitter } from "lucide-react"
            ...
            <div className={footerStyles.newsletterSection}>
                <div className={footerStyles.newsletterContent}>
                    ...
                    <p className={footerStyles.newsletterText}>
                        Subscribe to our newsletter to receive exclusive offers, new collection announcements, and styling tips.
                    </p>
            ...
            <div className={footerStyles.mainGrid}>
                <div className={footerStyles.brandSection}>
                    ...
                    <p className={footerStyles.brandDescription}>
                        Crafting timeless pieces for the discerning individual. Where meets elegance in every detail.
                    </p>
