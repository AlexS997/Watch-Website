...
const App = () => {
  ...
  return (
    <div className='min-h-screen w-full overflow-x-hidden antialiased bg-white text-slate-900'>
      ...
      <button onClick={scrollToTop} aria-label="Scroll to top" className={`fixed right-6 bottom-6 z-50 flex items-center justify-center p-3 rounded-full shadow-lg transition-all duration-300
          ${
            showButton
