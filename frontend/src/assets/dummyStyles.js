...
export const contactPageStyles = {
  ...
  // Creative card
  creativeCardBase: "rounded-2xl p-4 bg-gradient-to-r shadow-lg",
  ...
  creativeCardButtonBase: "inline-flex bg-gradient-to-br from-gray-100 to-gray-300 items-center gap-2 px-3 py-2 rounded-lg text-gray-800 text-sm font-medium shadow-sm",
...
export const signUpStyles = {
  ...
  inputField: "w-full pl-10 p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-400 focus:border-transparent transition text-gray-500",
...
export const loginPageStyles = {
  ...
  // Input styles
  inputBase: "w-full pl-10 p-3 text-gray-500 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all duration-200",
  passwordInputBase: "w-full pl-10 pr-10 p-3 text-gray-500 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all duration-200",
