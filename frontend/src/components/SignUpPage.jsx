            ...
            <div className={signUpStyles.formContainer}>
                <div className={signUpStyles.card}>
                    ...
                    <p className={signUpStyles.subtitle}>
                        Simple Signup to get started - light & clean
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className={signUpStyles.form}>
                        ...
                        <div className={signUpStyles.inputContainer}>
                            ...
                            <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder='Enter Full Name' className={signUpStyles.inputField} required />
                        </div>
                        ...
                        <div className={signUpStyles.inputContainer}>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder='john@example.com' className={signUpStyles.inputField} required />
                        </div>
                        ...
                        <div className={signUpStyles.inputContainer}>
                            ...
                            <input type={showPassword ? "text" : "password"}  value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Create a password' className={signUpStyles.inputField} required />

                            <button className={signUpStyles.passwordToggleButton} type='button' onClick={() => setShowPassword(!showPassword)} >
                                {showPassword ? (
